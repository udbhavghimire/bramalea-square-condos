...
<head>
    ...
    <meta name="description" content="Bramalea Square Condos by Essence Homes and Yau Shin Investments Inc is an upcoming pre construction condo development in 16 Lisa Street, Brampton, Brampton">
    <meta name="keywords" content="Bramalea Square Condos Brampton , Bramalea Square Condos, Bramalea Square Condos Brampton, Essence Homes and Yau Shin Investments Inc, Pre construction in brampton,  Singles and towns in Brampton, Pre consruction single and towns brampton">
...
<body>
        ...
        <nav class="navbar navbar-expand-lg fixed-top" id="navbar">
            <div class="container pt-2">
                <a href="/" class="navbar-brand">
                    <img src="./images/bramalea-square-white.webp" class="img-fluid navbar-brand navbar-brand-sm " alt="">
                </a>
    ...
    <section id="hero">
        <div class="container">
            <div class=" hero-container" >
                <div >
                <h1 class="main-titlee pb-0  mb-0 mt-2 mt-md-0" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">Bramalea Square Condos</span>
                </h1>
                <p class=" headline-textt mt-0 pt-3 text-white" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">CONDOMINIUMS COMING SOON TO DIXIE & QUEEN E.</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="rounded-3">
                    <div class="d-flex justify-content-between align-items-center pb-3">
                        ...
                        ">
                            <div class="col">
                                <div class="afte">
                                    <img loading="lazy" src="images/1.jpeg" alt="Bramalea Square Condos" class="img-fluid imghei">
                                </div>
                            </div>
                            <div class="col">
                                <div class="afte">
                                    <img loading="lazy" src="images/2.jpeg" alt="Bramalea Square Condos" class="img-fluid imghei">
                                </div>
                            </div>
                            <div class="col">
                                <div href="#" class="afte">
                                    <img loading="lazy" src="images/3.jpeg" alt="Bramalea Square Condos" class="img-fluid imghei">
                                </div>
                            </div>
                            <div class="col">
                                <div href="#" class="afte">
                                    <img loading="lazy" src="images/4.jpeg" alt="Bramalea Square Condos" class="img-fluid imghei">
                                </div>
                            </div>
        ...
        <div class="container pt-md-5 pt-5" id="location">
            ...
            <div class="py-5" data-aos="fade-up" data-aos-duration="2000" data-aos-delay="50">
                ...
                <span class="small-text text-center d-flex justify-content-center custom-underline pb-3">16 Lisa Street, Brampton, ON.</span>
                    ...
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d940.3282267936072!2d-79.72925019738443!3d43.71290690915931!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882b3de34e0495b1%3A0xaacce4969154acb0!2s16%20Lisa%20St.%2C%20Brampton%2C%20ON%20L6T%205R2%2C%20Canada!5e0!3m2!1sen!2snp!4v1694616068126!5m2!1sen!2snp" width="900" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
    ...
    <section>
       ...
       <div style="padding: 0; margin: 0; border: 0; outline: 0; width: 300px; border: 1px solid #999;"> <div style="border:0;outline:0;padding:0; margin: 11px 9px 0;"><h2 style="text-overflow: ellipsis; overflow: hidden; white-space: nowrap; padding: 0; margin: 0; border: 0; outline: 0; text-decoration: none; vertical-align: baseline; font-style: normal; background: none; text-align: left; font:15px/19px 'Arial Black', Gadget, sans-serif; font-weight: normal; color: #222;"> 16 Lisa Street </h2><h3 style="text-overflow: ellipsis; overflow: hidden; white-space: nowrap; padding: 0; margin: 0; border: 0; outline: 0; text-decoration: none; vertical-align: baseline; font-style: normal; background: none; text-align: left; font:12px/14px Verdana, Arial, Helvetica, sans-serif; font-weight: bold; color: #666; margin: 2px 0 4px 0;"> Very Walkable </h3> <div style="padding: 0; margin: 0; border: 0; outline: 0; position: relative; width: 100%; padding-bottom: 30%"> <div style="padding: 0; margin: 0; border: 0; outline: 0; position: absolute; top: 0; bottom: 0; left: 0; right: 0;"> <a rel="nofollow" href="https://www.walkscore.com/score/16-Lisa-Street-Brampton--CA.dash.ON-L6T-5R2?utm_source=badge&utm_medium=responsive&utm_campaign=badge"><!--[if lte IE 8]><img src="//pp.walk.sc/badge/walk/16-Lisa-Street-Brampton--CA.dash.ON-L6T-5R2.png" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Walk Score of 16 Lisa Street Brampton ON Canada"><![endif]--> <!--[if gt IE 8]><img src="//pp.walk.sc/badge/walk/16-Lisa-Street-Brampton--CA.dash.ON-L6T-5R2.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Walk Score of 16 Lisa Street Brampton ON Canada"><![endif]--> <!--[if !IE]> <!-- --><img src="//pp.walk.sc/badge/walk/16-Lisa-Street-Brampton--CA.dash.ON-L6T-5R2.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Walk Score of 16 Lisa Street Brampton ON Canada"><!-- <![endif]--><!--[if lte IE 8]><img src="//pp.walk.sc/badge/transit/16-Lisa-Street-Brampton--CA.dash.ON-L6T-5R2.png" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Transit Score of 16 Lisa Street Brampton ON Canada"><![endif]--> <!--[if gt IE 8]><img src="//pp.walk.sc/badge/transit/16-Lisa-Street-Brampton--CA.dash.ON-L6T-5R2.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Transit Score of 16 Lisa Street Brampton ON Canada"><![endif]--> <!--[if !IE]> <!-- --><img src="//pp.walk.sc/badge/transit/16-Lisa-Street-Brampton--CA.dash.ON-L6T-5R2.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Transit Score of 16 Lisa Street Brampton ON Canada"><!-- <![endif]--><!--[if lte IE 8]><img src="//pp.walk.sc/badge/bike/16-Lisa-Street-Brampton--CA.dash.ON-L6T-5R2.png" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Bike Score of 16 Lisa Street Brampton ON Canada"><![endif]--> <!--[if gt IE 8]><img src="//pp.walk.sc/badge/bike/16-Lisa-Street-Brampton--CA.dash.ON-L6T-5R2.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Bike Score of 16 Lisa Street Brampton ON Canada"><![endif]--> <!--[if !IE]> <!-- --><img src="//pp.walk.sc/badge/bike/16-Lisa-Street-Brampton--CA.dash.ON-L6T-5R2.svg" style='border-radius: 0; box-shadow: none; outline: 0; color: transparent; margin: 0 0 0 2.000000%; float: left; padding: 0; width: 30.666667%; background: none; border: 0;'alt="Bike Score of 16 Lisa Street Brampton ON Canada"><!-- <![endif]--></a></div> </div><p style="text-overflow: ellipsis; overflow: hidden; white-space: nowrap; padding: 0; margin: 0; border: 0; outline: 0; color: #999; font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif; line-height: 13px; clear:both; padding: 8px 0;"><a rel="nofollow" style="text-overflow: ellipsis; overflow: hidden; white-space: nowrap; padding: 0; margin: 0; border: 0; outline: 0; text-decoration: none; vertical-align: baseline; font-style: normal; background: none; text-align: left; color: #999; font-size: 11px; font-family: Verdana, Arial, Helvetica, sans-serif; line-height: 13px;" target="_blank" href="https://www.walkscore.com/CA-ON/Brampton?utm_source=badge&utm_medium=responsive&utm_campaign=badge">Explore Brampton on Walk Score</a><img style="visibility: hidden;" width=1 height=1 src="https://www.redfin.com/rift?ev=external_web&p=walkscore&s=score_badge&a=impression" /> </p></div></div>
       </div>
        <div class="pt-4 ">
        <span class="small-text text-center d-flex justify-content-center custom-underline pb-3 textt">(Bramalea Square Condos) 
        16 Lisa Street has a Walk Score of 7 out of 100. This location is a Car-Dependent neighborhood so almost all errands require a car.

This location is in Brampton. Nearby parks include Norton Place Park, Clark Park and Knightsbridge Park.
  ...
  <div class="accordion-item">
    ...
    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
      <div class="accordion-body">Bramalea Square Condos is coming soon in 16 Lisa Street, Brampton. </div>
    </div>
  </div>
  <div class="accordion-item">
                ...
                <div class="row row-cols-1 row-cols-md-3 mx-0 g-5 pb-md-5 ">
                    ...
                    <div class="col-md-6 px-md-5 ">
                        ...
                        <form action="./contactForm.php" method="POST">
                            ...
                            <div class="row ">
                                <p class=" text-muted sm-text text-center mt-0 ">*I consent to receive future communications about Bramalea Square Condos. I understand I can opt out at anytime by sending an email.</p>
                            </div>
                            <div class="row ">
